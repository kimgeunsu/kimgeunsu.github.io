...
**Periodically Updated Target**: Q는 오직 주기적인 updated로서 target values로 optimize 된다. Q network는 모든 C steps동안 Optimization target으로서 복제되고 frozen상태를 유지한다. 이것은 수정사항은 short-term oscillations를 극복하도록 하며, 훈련을 안정화 시킨다.   
